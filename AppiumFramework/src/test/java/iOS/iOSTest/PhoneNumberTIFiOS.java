...
public class PhoneNumberTIFiOS {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            booking.clickTextViewXpath(adult);
            Thread.sleep(3500);
            /** Swipes para ubicar los campos de contacto de emergencia **/
            tif.swipeFormTIF(PanelTripDetails, driver, direct2);
            tif.swipeFormTIF(PanelTripDetails, driver, direct2);
            tif.swipeFormTIF(PanelTripDetails, driver, direct2);
            tif.swipeFormTIF(PanelTripDetails, driver, direct2);
            tif.swipeFormTIF(PanelTripDetails, driver, direct2);
            ...
            while (cont!=91) {
                switch (cont) {
                    case 1:
                        tif.validateCountryPhoneNumbers(report, countryCode, phoneNumber1, phoneNumber2, phoneNumber3);
                        break;
                    case 2:
