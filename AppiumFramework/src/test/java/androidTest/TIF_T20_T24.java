...
public class TIF_T20_T24 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String PNR = data.extractData(11, 1, "TIF");
        String LastName = data.extractData(11, 2, "TIF");
        String PNR2 = data.extractData(11, 7, "TIF");
        String LastName2 = data.extractData(11, 8, "TIF");
        String adult = data.extractData(11, 3, "TIF"),
                child = data.extractData(11, 4, "TIF"),
                infant = data.extractData(11, 5, "TIF");
        String tripInternationalM = data.extractData(11, 6, "TIF");
        ...
        try {
            /** Crea el reporte **/
            report.createTestReport("Validación de campos REGULAR APIS Y GREEN CARD", "Para un vuelo internacional USA logueado");
            ...
            while (index != 6) { // Loop necesario para ejecutar con cada cuenta connect miles
                ...
                if (index == 1) {  //Estos pasos se hacen únicamente en el primer usuario CM ya que en los otros se usa
                    ...
                    tif.fillFieldsOnlyUsaResidentAndResidentCard("login");
                ...
                tif.regularApisGreenCardAndPersonalInformationValidations("adult","login", report);
                ...
                tif.regularApisGreenCardAndPersonalInformationValidations("infant","login", report);
                ...
                tif.swipeToAdultChildInfant(PanelTripDetails, driver, direct2);
                tif.swipeToAdultChildInfant(PanelTripDetails, driver, direct2);
                /** PASO 20. Click al pasajero child para validar los campos **/
                tif.clickEditInformation(child);
                /** PASO 21. Valida los campos en el pasajero child **/
                tif.regularApisGreenCardAndPersonalInformationValidations("child","login", report);
                tif.clickBack();
                tif.clickBackFlightDetails();
