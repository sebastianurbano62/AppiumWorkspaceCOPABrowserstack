...
public class TIF_T8_T12 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String PNR = data.extractData(5, 1, "TIF");
        String LastName = data.extractData(5, 2, "TIF");
        String PNR2 = data.extractData(5, 7, "TIF");
        String LastName2 = data.extractData(5, 8, "TIF");
        String adult = data.extractData(5, 3, "TIF"),
                child = data.extractData(5, 4, "TIF"),
                infant = data.extractData(5, 5, "TIF");
        String tripInternationalB = data.extractData(5, 6, "TIF");
