...
public class TIF_T19 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String PNR2 = data.extractData(10, 7, "TIF");
        String LastName2 = data.extractData(10, 8, "TIF");
        ...
        try {
            ...
            tif.swipeToAdultChildInfant(PanelTripDetails, driver, direct2);
            tif.swipeToAdultChildInfant(PanelTripDetails, driver, direct2);
            /** PASO 15. Click al pasajero child para validar los campos **/
