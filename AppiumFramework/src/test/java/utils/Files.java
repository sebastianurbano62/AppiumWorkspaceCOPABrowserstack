...
public final class Files
{
    ...
    public String createFolder() {
        //String path = "C:\\Users\\Maykol de Gracia\\Documents\\Reportes de ejecución\\";
        //String path = "/Users/hdqebsqa01/Documents/Reportes/Android/";
        String path = "C:\\Users\\Sebastian Urbano\\OneDrive\\Documentos\\Reportes de ejecución\\";
        // Obtenemos la fecha y hora actual
        Date fechaActual = new Date();
        SimpleDateFormat formatoFecha = new SimpleDateFormat("yyyy-MM-dd");
        // SimpleDateFormat formatoFechaHora = new SimpleDateFormat("yyyy-MM-dd_HH.mm.ss");
        String fechaFormateada = formatoFecha.format(fechaActual);

        // Creamos la carpeta con la fecha y hora actual como nombre
        String reportPath = path + fechaFormateada;
        File carpeta = new File(reportPath);
        if (carpeta.exists()) {
            return path + carpeta.getName();
        } else {
            if (carpeta.mkdir()) {
